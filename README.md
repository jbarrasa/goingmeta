...
| #  | broadcast | title |tags| recording  | code |
|---:|:-----:| -----:|:---------:|:--------------------------:|:---:|
| 1  | October 7 | Ontology Creation with the Neo4j MCP Server | `LLM` `Knowledge Graph` `GraphRAG` `Agents` `MCP` `Modelling` | [📺](https://youtube.com/live/lAg7ZweHhbI) | [💻](https://github.com/jbarrasa/goingmeta/tree/main/session39) |
| 2  | November 4 | tbd | | [📺](#) | [💻](#) |
